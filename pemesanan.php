...
<main id="main" class="main">
    ...
    <div class="pagetitle"><h1><strong>Menu </strong>Transksi Pemesanan</h1>
        <nav>
            <ol class="breadcrumb">
                        ...
                        <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <input type="number" class="form-control total_harga" id="total_harga" name="total_harga" readonly>
                                    </td>

                                    <td>
                                        <button class="btn btn-warning" id="total_bayar" name="total_bayar" style="width: 100px;">Total</button>
                                    </td>
                                </tr>
                            </tbody>
...
<script type="text/javascript">
    ...
    function isi_otomatis2(element) {
        ...
        $(row_item).find('.harga_permeter').val(data.harga_permeter);}).fail(function() {
